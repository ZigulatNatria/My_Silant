    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drive_axle_model', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.driveaxlemodel')),
                ('engine_model', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.enginemodel')),
            ],
            options={
                'verbose_name': 'Машина',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.servicetype')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.servicecompany'),
        ),
        migrations.AddField(
            model_name='machine',
            name='steering_bridge_model',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.steeringbridgemodel'),
        ),
        migrations.AddField(
            model_name='machine',
            name='technique_model',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.techniquemodel'),
        ),
        migrations.AddField(
            model_name='machine',
            name='transmission_model',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.transmissionmodel'),
        ),
        migrations.CreateModel(
            name='Complaint',
            fields=[
                ...
                ('failure_node', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.failurenode')),
                ('machine_complaint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.machine')),
                ('recovery_method', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='service.recoverymethod')),
            ],
            options={
